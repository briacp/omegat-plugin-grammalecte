...
class GrammalecteIssue implements IIssue {
    ...
    private final GrammalecteResult result;

    GrammalecteIssue(SourceTextEntry ste, String targetText, GrammalecteResult result) {
        this.ste = ste;
    ...
    public String getTypeName() {
        return GrammalectePlugin.res.getString("ISSUES_GRAMMALECTE_TYPE");
    }
